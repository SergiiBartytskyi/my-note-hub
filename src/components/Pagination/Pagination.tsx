...
export default function Pagination({ totalPages, currentPage, setPage }: PaginationProps) {
  return (
    <ReactPaginate
      ...
      pageLinkClassName="flex h-full w-full cursor-pointer items-center justify-center text-slate-700 transition-transform active:scale-[0.98]"
      ...
      previousLinkClassName="flex h-full w-full cursor-pointer items-center justify-center text-slate-700 transition-transform active:scale-[0.98]"
      nextLinkClassName="flex h-full w-full cursor-pointer items-center justify-center text-slate-700 transition-transform active:scale-[0.98]"
      breakClassName="h-10 w-10"
      breakLinkClassName="flex h-full w-full items-center justify-center text-slate-500"
      disabledClassName="cursor-not-allowed border-slate-200 bg-slate-100 opacity-50"
